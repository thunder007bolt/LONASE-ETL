...
class EditecLotoLoad(Loader):
    def __init__(self):
        ...
        log_file = 'logs/loader_editec_loto_lots.log'
        columns = [
            "agentlogin",
            "retailcategory",
            "TotalDrawGamePaidAmount",
            "jour",
            "annee",
            "mois"
        ]
        table_name = "[DWHPR_TEMP].[OPTIWARETEMP].[SRC_PRD_EDITEC_LOTO_LOTS]"
...
def run_editec_loto_lots_loader():
    loader = EditecLotoLoad()
    loader.process_loading()

if __name__ == "__main__":
    run_editec_loto_lots_loader()
0