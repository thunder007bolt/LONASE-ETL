...
class ExtractGitechLotto(BaseScrapper):
    def __init__(self, env_variables_list):
        super().__init__('gitech_lotto_ca', env_variables_list, 'logs/extract_gitech_lotto_ca.log')
        self.file_path = None
...
def run_gitech_lotto_ca():
    env_variables_list = ["GITECH_LOGIN_USERNAME", "GITECH_LOGIN_PASSWORD"]
    job = ExtractGitechLotto(env_variables_list)
